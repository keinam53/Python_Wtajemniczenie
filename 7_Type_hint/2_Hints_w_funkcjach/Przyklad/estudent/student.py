...
class Student:
    ...
    @staticmethod
    def from_csv(first_name: str, last_name: str, promoted: bool, grades_values: list[int]) -> Student:
    ...
    @staticmethod
    def from_json(first_name: str, last_name: str, promoted: bool, final_grades: list[dict[str, str]]) -> Student:
        student = Student(first_name, last_name)
        student.promoted = promoted
