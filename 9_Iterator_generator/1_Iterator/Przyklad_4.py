...
class Tasks:
    ...
    def add_major_task(self, tasks: str) -> None:
        self.major_tasks.append(tasks)

    def add_minor_task(self, tasks: str) -> None:
        self.minor_tasks.append(tasks)
