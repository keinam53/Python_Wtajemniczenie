...
def cinema_movies_schedule(user):
    ...
    cinema_datetime_input = input(
        f"Kiedy chcesz iść do kina? ({date_and_time_format.datetime_format}): ")
    ...
    schedule = cinema_schedule.schedule_for_period(cinema_date, cinema_schedule.weekly_schedule_template)
    print("W ciągi tego tygodnia możesz obejrzeć:")
