...
class StudentTestCase(TestCase):
    def setUp(self) -> None:
        ...
        self.student_with_grade.add_final_grade(grade=5, check_promotion_policy=lambda grades: False)
    ...
    def test_grades_average(self):
        self.student.add_final_grade(grade=5, check_promotion_policy=lambda grades: False)
        self.student.add_final_grade(grade=3, check_promotion_policy=lambda grades: False)

        self.assertEqual(self.student.grades_avg(), 4)
    ...
    def test_add_final_promote_student_when_have_proper_grades(self):
        self.student.add_final_grade(grade=5, check_promotion_policy=lambda grades: grades[0].value == 5)

        self.assertTrue(self.student.promoted)

    def test_add_final_wont_promote_student_when_doesnt_have_proper_grades(self):
        self.student.add_final_grade(grade=4, check_promotion_policy=lambda grades: grades[0].value == 5)
