...
class Student:
    ...
    @staticmethod
    def from_json(first_name: str, last_name: str, promoted: bool, final_grades: list[FinalGradesDict]) -> Student:
        student = Student(first_name, last_name)
        student.promoted = promoted
    ...
    def add_final_grade(
        ...
        grade: int,
        subject: str,
        check_promotion_policy: Union[PromotionPolicyFunc] = None,
    ) -> None:
