...
def run_example() -> None:
    ...
    welcome_email = WelcomeEmail(
        first_name="Jan", last_name="Kowalski", signature="Pozdrawiam, Mariusz"
    )
    ...
    mail_sender.send_email("mailing@zxy.pl", jan_email, welcome_email)
    mail_sender.send_email("mailing@zxy.pl", jan_email, registration_email)
